...
user1.name = "Daniel Seol";
user1.username = "FodderOtter";
...
//   this.ssn = ssn;
// };
// var Daniel = new makePerson("Daniel", "06/14", 1711311);
...
var daniel = new MakePerson ("Daniel", "06/14", 81871221);
...
//   };
// };
// makePerson("Daniel", "06/14", 1251241);
...
var chase = new MakeCard(12312453, "06/18", 112);
...
function bindCard(person, creditCard) {
  ...
  for (var personKey in person) {
    personCard[personKey] = person[personKey];
  }
  for (var cardKey in creditCard) {
    personCard[cardKey] = creditCard[cardKey];
  }
  return personCard;
}
var DSCC = bindCard(Daniel, Chase);
console.log(DSCC);
